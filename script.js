 ...
 * Catálogo, filtros, busca, ordenação, WhatsApp e animações
 */
    ...
    <div class="fruit-body">
      ...
      <div class="fruit-prices">
        ...
        <span class="fruit-price-ref">
          R$ ${formatPrice(fruta.precoReferencia)}
        </span>
...
function openWhatsApp(fruta) {
  const mensagem =
    `Olá, quero comprar a fruta "${fruta.nome}" ` +
    `com o valor de R$ ${formatPrice(fruta.precoLoja)}.`;
...
function observeCards() {
  ...
  document
    .querySelectorAll(".fruit-card:not(.visible)")
    .forEach((card) => {
